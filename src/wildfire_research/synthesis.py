...
def build_preliminary_synthesis_markdown(
    *,
    ...
    lines = [
        ...
        "- ERA5-Land now has a complete, content-validated 2015-2025 monthly window and a provenance receipt, but event-cutoff lag extraction is not yet linked to observation rows.",
        ...
        "",
        "- **Module 1 — environmental conditions (Phase 1B → Phase 2):** highest priority and not yet estimable. ERA5-Land is complete and a partial 2015 CHIRPS lag cache exists, but multi-year CHIRPS support, QA-valid pre-fire vegetation, and a processed VIIRS observation denominator must pass before the interaction model is fitted.",
        "- **Module 2A — fire followed by land-cover change (Phase 3):** the next feasible extension. It can test whether fire-positive cells are followed by forest loss or conversion in 1–3 years, but cannot identify palm expansion or intent without dated plantation evidence.",
        ...
        "",
        "Recommended order: close Module 1, prepare Module 2A, standardize Module 4, and attempt Modules 2B/3 last. This ordering follows both scientific identifiability and data availability.",
        "",
    ]
    return "\n".join(lines)
