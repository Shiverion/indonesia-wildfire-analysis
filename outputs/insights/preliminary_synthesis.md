...
- **Module 1 — environmental conditions (Phase 2 complete):** the primary peat ≥50% × root-zone dryness test is inconclusive. The required fallback exclusion is materially similar; 25% and locked-test sensitivities trend lower, but cannot replace the frozen primary result.
