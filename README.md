...
Read the Phase 2 result in [phase2_environmental_association.md](outputs/insights/phase2_environmental_association.md), the completed Phase 3 result in [phase3_fire_to_land_change.md](outputs/insights/phase3_fire_to_land_change.md), the [publication robustness audit](outputs/insights/phase3_publication_robustness.md), the broader evidence-bounded conclusion in [preliminary_synthesis.md](outputs/insights/preliminary_synthesis.md), and the audit trail in [PHASE_LOG.md](PHASE_LOG.md). The technical manuscript, supplement, final figures/tables, self-contained HTML report, citation file, licences, and coordinate-free release manifest are under [publication](publication/README.md).

An auxiliary, offline visual companion is available at [outputs/evidence-explorer/index.html](outputs/evidence-explorer/index.html). The maintained Next.js dashboard presents one integrated, summary-first research report while keeping incompatible descriptive sources and the still-unidentified human track separate. Its public reading order is the primary forest-loss finding, the peat/climate mechanism test, Indonesia and global context, Kalimantan detail, and then methods and provenance. No raw hotspot coordinates, private cell coordinates, or 1-km prediction surface are released.
