...
An auxiliary, offline visual companion is available at [outputs/evidence-explorer/index.html](outputs/evidence-explorer/index.html). The maintained Next.js dashboard presents the compact Phase 2 and Phase 3 results while keeping incompatible descriptive sources and the still-unidentified human track separate. No raw hotspot coordinates, private cell coordinates, or 1-km prediction surface are released.
